...
#import "formulateAppDelegate.h"
#import "FormulateViewController.h"

@implementation formulateAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.window.rootViewController = [[[FormulateViewController alloc] init] autorelease];
    //CFURLRef pdfURL = CFBundleCopyResourceURL(CFBundleGetMainBundle(), CFSTR("form.pdf"), NULL, NULL);
    //[self.viewController loadPdf:pdfURL];
